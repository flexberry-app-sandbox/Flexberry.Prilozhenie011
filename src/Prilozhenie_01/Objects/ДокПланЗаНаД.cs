...
namespace IIS.Prilozhenie_01
{
    ...
    public class ДокПланЗаНаД : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_01.DetailArrayOfТЧПлЗНаД fТЧПлЗНаД;
        ...
        public virtual IIS.Prilozhenie_01.DetailArrayOfТЧПлЗНаД ТЧПлЗНаД
        {
            get
            {
                ...
                {
                    this.fТЧПлЗНаД = new IIS.Prilozhenie_01.DetailArrayOfТЧПлЗНаД(this);
                }
                IIS.Prilozhenie_01.DetailArrayOfТЧПлЗНаД result = this.fТЧПлЗНаД;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокПланЗаНаДE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокПланЗаНаДE", typeof(IIS.Prilozhenie_01.ДокПланЗаНаД));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокПланЗаНаДL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокПланЗаНаДL", typeof(IIS.Prilozhenie_01.ДокПланЗаНаД));
                }
            }
        }
    }
