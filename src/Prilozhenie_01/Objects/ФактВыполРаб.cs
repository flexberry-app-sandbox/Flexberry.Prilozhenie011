...
namespace IIS.Prilozhenie_01
{
    ...
    public class ФактВыполРаб : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_01.СпрОбъектСтр fСпрОбъектСтр;
        
        private IIS.Prilozhenie_01.СпрПользов fСпрПользов;
        
        private IIS.Prilozhenie_01.DetailArrayOfТЧФактВыпР fТЧФактВыпР;
        ...
        [PropertyStorage(new string[] {
                "СпрОбъектСтр"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_01.СпрОбъектСтр СпрОбъектСтр
        {
            get
            {
                ...
                IIS.Prilozhenie_01.СпрОбъектСтр result = this.fСпрОбъектСтр;
        ...
        [PropertyStorage(new string[] {
                "СпрПользов"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_01.СпрПользов СпрПользов
        {
            get
            {
                ...
                IIS.Prilozhenie_01.СпрПользов result = this.fСпрПользов;
        ...
        public virtual IIS.Prilozhenie_01.DetailArrayOfТЧФактВыпР ТЧФактВыпР
        {
            get
            {
                ...
                {
                    this.fТЧФактВыпР = new IIS.Prilozhenie_01.DetailArrayOfТЧФактВыпР(this);
                }
                IIS.Prilozhenie_01.DetailArrayOfТЧФактВыпР result = this.fТЧФактВыпР;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФактВыполРабE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФактВыполРабE", typeof(IIS.Prilozhenie_01.ФактВыполРаб));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФактВыполРабL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФактВыполРабL", typeof(IIS.Prilozhenie_01.ФактВыполРаб));
                }
            }
        }
    }
